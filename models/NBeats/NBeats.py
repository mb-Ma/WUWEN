...
class NBeats(t.nn.Module):
    ...
    def __init__(self, args):
        ...
        if type == "generic":
            ...
            trend_layers = args["trend_layers"]
            trend_layer_size = args["trend_layer_size"]
            degree_of_polynomial = args["degree_of_polynomial"]
            seasonality_blocks = args["seasonality_blocks"]
            seasonality_layers = args["seasonality_layers"]
            seasonality_layer_size = args["seasonality_layer_size"]
            num_of_harmonics = args["num_of_harmonics"]
    ...
    def forward(self, input) -> t.Tensor:
        ...
        history_data, x_time = input
        x = history_data.squeeze() # (B, L)
